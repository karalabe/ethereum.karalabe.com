...
var oracleAddress = common.HexToAddress("0xfa7b9770ca4cb04296cac84f37736d4041251cdf")

func main() {
	ec, _ := ethclient.Dial("/home/karalabe/.ethereum/geth.ipc")
	ro, _ := NewReleaseOracle(oracleAddress, ec) // HL

	ver, _ := ro.CurrentVersion(nil) // HL
	fmt.Printf("Latest Geth: v%d.%d.%d", ver.Major, ver.Minor, ver.Patch)
}
